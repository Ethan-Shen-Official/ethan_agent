...
def test_sse_text_and_tool_call_chunks_are_normalized():
    ...
    lines = [
        b'data: {"choices":[{"delta":{"content":"hello"}}]}\n',
            b'data: {"choices":[{"delta":{"tool_calls":[{"index":0,"id":"call_1","function":{"name":"read","arguments":"{\\"path\\":"}}]}}]}\n',
    ...
    assert events[2].tool_call == ToolCall("call_1", "read", {"path": "a.txt"})
...
def test_request_payload_contains_messages_and_tools():
    ...
    request = ModelRequest(
        ...
        tools=(ToolSpec("read", "Read", {"type": "object", "properties": {"path": {"type": "string"}}}),),
